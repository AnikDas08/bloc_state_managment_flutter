...
class ApiService {
  ...
  static ApiResponseModel _handleResponse(Response response) {
    ...
    if (response.statusCode == 401 && response.data['message'] == "Session Expired") {
      LocalStorage.removeAllPrefData();
      // TODO: Navigate to Sign In screen using your preferred navigation solution (e.g., Navigator or a Router)
    }
    ...
    switch (error.type) {
      ...
      case DioExceptionType.badResponse:
        if (error.response?.statusCode == 401 &&
          ...
          LocalStorage.removeAllPrefData();
          // TODO: Navigate to Sign In screen using your preferred navigation solution
        }
